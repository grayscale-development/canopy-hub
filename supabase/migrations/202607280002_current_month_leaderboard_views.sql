drop view if exists data.april_branch_summary cascade;
drop view if exists data.april_division_summary cascade;
drop view if exists data.april_loan_officer_summary cascade;
drop view if exists data.april_processor_summary cascade;
drop view if exists data.april_underwriter_summary cascade;
drop view if exists data.april_underwriting_org_summary cascade;
